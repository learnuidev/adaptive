...
const featureFlags = [
  {
    ...
    description: "New modern UI with improved user experience and accessibility features",
    enabled: true,
  ...
  },
  {
    ...
    description: "Enhanced analytics with machine learning insights and predictive modeling",
    enabled: false,
  ...
  },
  {
    ...
    description: "Native mobile app features and cross-platform synchronization",
    enabled: true,
  ...
  },
  {
    ...
    description: "Artificial intelligence powered data analysis and recommendations",
    enabled: false,
    rolloutPercentage: 5,
