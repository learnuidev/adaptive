      ...
      <SidebarContent className="p-4">
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild>
                    <NavLink 
                      ...
                      className={`rounded-lg transition-all duration-200 ${getNavCls({ isActive: isActive(item.url) })}`}
                    >
        ...
        <div className="mt-auto space-y-2">
          ...
          <SidebarMenuButton asChild>
            <NavLink 
              to="/settings" 
              className={`rounded-lg transition-all duration-200 ${getNavCls({ isActive: isActive('/settings') })}`}
            >
