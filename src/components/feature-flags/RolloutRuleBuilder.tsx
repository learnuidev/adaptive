...
export function RolloutRuleBuilder({ rules, onChange, websiteId }: RolloutRuleBuilderProps) {
  ...
  const updateField = (
    ...
    const newRules = [...rules];
    newRules[groupIndex].fields[fieldIndex][key] = value;
    onChange(newRules);
  };
            ...
            {group.fields.map((field, fieldIndex) => (
              <div key={fieldIndex} className="flex items-center gap-2">
                ...
                <Select
                  value={field.field}
                  onValueChange={(value) =>
                    updateField(groupIndex, fieldIndex, "field", value)
                  }
                >
                ...
                <Select
                  value={field.op}
                  onValueChange={(value) =>
                    updateField(groupIndex, fieldIndex, "op", value)
                  }
                >
                ...
                <Input
                  ...
                  value={field.value}
                  onChange={(e) =>
                    updateField(groupIndex, fieldIndex, "value", e.target.value)
                  }
                  className="flex-1"
                />
